        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 md:gap-x-8 lg:gap-x-12 mb-16">
          ...
          <div className="text-center lg:text-center">
            ...
            <div className="flex flex-col gap-4 text-xs font-bold uppercase tracking-widest text-stone-500">
              <Link to="/termos-de-uso" className="hover:text-brand-primary transition-colors">{t('legal.terms_title')}</Link>
              <Link to="/politica-de-privacidade" className="hover:text-brand-primary transition-colors">{t('legal.privacy_title')}</Link>
